...
export const CommentsModal = ({isModalVisible, toggleModal}) => {
  const comments = [
    {id: 1, text: 'Comment 1', user: 'User 1'},
    {id: 2, text: 'Comment 2', user: 'User 2'},
    {id: 3, text: 'Comment 3', user: 'User 3'},
    {id: 4, text: 'Comment 4', user: 'User 4'},
    {id: 5, text: 'Comment 5', user: 'User 5'},
    {id: 6, text: 'Comment 6', user: 'User 6'},
    {id: 7, text: 'Comment 7', user: 'User 7'},
    {id: 8, text: 'Comment 8', user: 'User 8'},
    {id: 9, text: 'Comment 9', user: 'User 9'},

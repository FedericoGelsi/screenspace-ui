...
export const CinemaFormAddressView = ({dispatch, formValues, completeForm}) => {
  return (
    <>
      ...
      <Input
        ...
        onChangeText={text =>
          dispatch(completeForm({key: 'address', value: text}))
        }
      />
      <Input
        ...
        style={styles.formCtrl}
        onChangeText={text =>
          dispatch(completeForm({key: 'postalCode', value: text}))
        }
      />
      <Input
        ...
        style={styles.formCtrl}
        onChangeText={text =>
          dispatch(completeForm({key: 'city', value: text}))
        }
      />
      ...
      <Input
        ...
        style={styles.formCtrl}
        onChangeText={text =>
          dispatch(completeForm({key: 'country', value: text}))
        }
      />
    </>
  );
